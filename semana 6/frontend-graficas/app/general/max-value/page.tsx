...
import { fetchMaxValue } from "@/app/service/api";
      ...
      .then((data) => {
        ...
        if (data.length > 0) {
          setChartData({
            ...
            datasets: [
              {
                label: "Maximo valor por tipos de producto",
                data: data.map((item: any) => item.valorMaximo),
                backgroundColor: "rgba(59, 130, 246, 0.4)",
                borderColor: "rgba(59, 130, 246, 1)",
                borderWidth: 2,
              },
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 p-6">
      <div className="w-full max-w-2xl rounded-2xl bg-white p-6 shadow-lg">
        <h2 className="mb-4 text-center text-xl font-semibold text-gray-700">
          Gráfico de valor maximo de productos
        </h2>
